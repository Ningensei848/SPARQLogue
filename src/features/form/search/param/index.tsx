...
import { replaceEditor } from '~/src/features/editor/editorSlice'
import { TextInputEditable } from '~/src/features/form/edit/param/textInput'
import { FormOption, selectFormOptById, FormVariable } from '~/src/features/form/formSlice'
import { FormElement, StylingProps } from '~/src/features/form/types'
import { useAppDispatch } from '~/src/store'
import { RootState } from '~/src/store/rootReducer'

interface paramSearchProps {
  formVarState: FormVariable
  styleProps?: StylingProps
}

interface createFormElemProps extends paramSearchProps {
...
export const ParamOnSearchForm: React.FC<paramSearchProps> = (props) => {
