...
import { selectFormVarById } from '~/src/features/form/formSlice'
import { GeneratedHTMLProps, StylingProps } from '~/src/features/form/types'
...
const cssEscape = (styleProps: StylingProps | undefined): string => {
  ...
  if (styleProps && typeof styleProps.textInput === 'string'){
    const hoge = styleProps.textInput?.split('\n').map(line => line.trim()).join(' ')
