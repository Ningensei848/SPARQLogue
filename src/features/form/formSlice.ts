...
import {
  ...
  deleteFormList,
  upsertAtMarks
} from '~/src/features/form/common/reduceFunctions'

export interface FormVariable {
  id: string | number // random generated value (e.g. Date.now())
...
export interface FormOption {
  id: string | number // same as FormVariable.id
  at: 'param' | 'endpoint' | 'proxy' | 'author' | 'title'
  name: string
  elem: string | string[]
  parent_id: string | number
...
export interface Form {
  id: string | number // inherited value (props.id)
...
export interface FormState {
  variables: EntityState<FormVariable>
  options: EntityState<FormOption>
  forms: EntityState<Form>
}
