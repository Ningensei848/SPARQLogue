...
import { AtMark } from '~/src/common/types'
import { isFormOptionName } from '~/src/common/util/validation'
import {
  FormOption,
  formOptionAdaptor,
  FormState,
...
import { FormChildIds, SearchUpdateResult } from '~/src/features/form/types'

interface operateFormStateProps {
  id: string | number
...
interface formChildrenProps {
  state: FormState
  list: { var: Array<string | number>; opt: Array<string | number> }
  adaptor: { var: EntityAdapter<FormVariable>; opt: EntityAdapter<FormOption> }
}
